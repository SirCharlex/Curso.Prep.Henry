...
function agregarSimboloExclamacion(str) {
  //24 Agrega un símbolo de exclamación al final de la string "str" y devuelve una nueva string
...
function obtenerSaludo(nombre) {
  //26 Toma la string "nombre" y concatena otras string en la cadena para que tome la siguiente forma:
  // "Martin" -> "Hola Martin!"
  // Tu código:
  return 'Hola ' + nombre + '!';
}
